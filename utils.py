...
def encode_meta_label(img_info,index_num):
    ...
    meta_vector2 = np.hstack([
        level_of_diagnostic_difficulty_label_index,
        evaluation_label_index,
        location_label_index,
        sex_label_index,
        management_label_index
    ])
    return meta_vector1,meta_vector2

def encode_meta_choosed_label(img_info,index_num):
